@tool
extends RefCounted
class_name IslandTerrainPaintTransaction
...
var action_name: String = "Terrain Paint"
var deltas: Array[RegionDelta] = []
var max_memory_bytes: int = Constants.DEFAULT_EDIT_TRANSACTION_BYTES
...
func append_transaction(other: IslandTerrainPaintTransaction) -> Error:
	if other == null:
		return ERR_INVALID_DATA
